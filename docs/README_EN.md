...
- ***The New York Times* on Firefox:** due to the way Firefox handles the dynamic loading ot [the NYT's homepage](https://www.nytimes.com), it needs to be opened in a new tab or window for the button to appear. In any other case, the button is likely to pop up briefly before disappearing.
