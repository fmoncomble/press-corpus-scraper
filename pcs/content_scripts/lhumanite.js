...
const anchor = document.querySelector('form[action*="?s="]');
console.log('Anchor located: ', anchor);
...
const premiumBannerDef = '.u-relative.u-icon-32';
...
const bodyDivDef = 'div.rich-text:not(.u-margin-b-3.u-padding-b-0.u-padding-t-0';
